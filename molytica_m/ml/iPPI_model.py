...
def create_iPPI_model(n_features=9):
...
def get_trained_iPPI_model():
    return load_model("molytica_m/ml/iPPI_model.h5", custom_objects={'GCNConv': GCNConv, 'GlobalAvgPool': GlobalAvgPool})
