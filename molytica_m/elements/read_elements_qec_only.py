...
def main():
    ...
    for element in elements_json["elements"]:
        ...
        element_properties["total_vector_fingerprint"] = element_properties["electron_configuration_vector"]
    ...
    with open('molytica_m/elements/element_vectors_qec_only.json', 'w') as fp:
